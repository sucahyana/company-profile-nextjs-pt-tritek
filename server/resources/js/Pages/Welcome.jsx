...
import background from '../assets/images/page-background.svg'
import designer from '../assets/images/logo-softwarehouse.png'
import dashboard from '../assets/images/dashboard.png'

export default function Welcome({auth, laravelVersion, phpVersion, feHost, information}) {
                ...
                <div
                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                            ...
                            <div className="grid gap-6 lg:grid-cols-2 lg:gap-8">
                                ...
                                >
                                    ...
                                    <div className="relative flex items-center gap-6 lg:items-end">
                                        <div id="docs-card-content" className="flex items-start gap-6 lg:flex-col">
                                            <div
                                                className="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#3F20FF]/10 sm:size-16">
                                                <svg
                                            ...
                                            <div className="pt-3 sm:pt-5 lg:pt-0">
                                                ...
                                                <p className="mt-4 text-sm/relaxed">
                                                    Mengatur Content Untuk Web PT tritek Indonesia Dikhususkan dan
                                        ...
                                        <svg
                                            className="size-6 shrink-0 stroke-[#3F20FF]"
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            strokeWidth="1.5"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        <h2 className="text-xl font-semibold text-black dark:text-white">Landing Page
                                            Tritek Indonesia</h2>

                                        <p className="mt-4 text-sm/relaxed">
                                            Lihat Preview Landing Page Tritek Indonesia
                                        </p>
                                    </div>

                                    <svg
                                        className="size-6 shrink-0 self-center stroke-[#3F20FF]"
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        strokeWidth="1.5"
                                ...
                                >
                                    ...
                                    <div className="pt-3 sm:pt-5">
                                        <h2 className="text-xl font-semibold text-black dark:text-white">
                                            Project PT Tritek Indonesia
                                        </h2>

                                        <p className="mt-4 text-sm/relaxed">
                                            Project yang mungkin bisa dilihat pada tritek indonesian
                                        </p>
                                    </div>
                        ...
                        <footer className="py-16 text-center text-sm text-black dark:text-white/70">
                           {laravelVersion} (Vol v {phpVersion})
                        </footer>
                    </div>
                </div>
            </div>
